 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/webservicetest/SayHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://service/", "SayHelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webservicetest/SayHello?wsdl");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://service/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
